...
public class FileListView 
{
	...
	public FileListView( Context context, ListSelector listSelector, int listType )
	{
		...
		data = new ArrayList< CompareItem >();
	...
	private class FileListItem extends ArrayAdapter< CompareItem >
	{
    	...
    	public View getView( int position, View convertView, ViewGroup parent )
    	{
    		...
    		if ( convertView == null )
    		{
				...
				itemHolder.topView = (TextView)convertView.findViewById( R.id.top_view );
				itemHolder.bottomView = (TextView)convertView.findViewById( R.id.bottom_view );
				itemHolder.icon = (ImageView)convertView.findViewById( R.id.row_image );
